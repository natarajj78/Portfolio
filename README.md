...
**Theme:** dark "systems / network" visual language — deep charcoal-navy
background, a violet-to-cyan gradient standing in for the connections
between problem and system, a node-graph hero graphic, and a vertical
gradient-line career timeline. Type is Space Grotesk (display), Inter
(body), and IBM Plex Mono (data/labels) — a deliberate move away from the
earlier warm-cream/serif version toward something that reads closer to
current AI-product design language.
